                                ...
                                <CardContent>
                                    <form onSubmit={handlePreRegister} className="space-y-3">
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                            <input required placeholder="Full Name" className="p-3 text-sm bg-gray-50 border border-gray-200 rounded-lg text-gray-900 placeholder-gray-400 focus:border-solar focus:ring-1 focus:ring-solar outline-none transition-all" value={newCustomer.name} onChange={e => setNewCustomer({ ...newCustomer, name: e.target.value })} />
                                            <input required type="email" placeholder="Email" className="p-3 text-sm bg-gray-50 border border-gray-200 rounded-lg text-gray-900 placeholder-gray-400 focus:border-solar focus:ring-1 focus:ring-solar outline-none transition-all" value={newCustomer.email} onChange={e => setNewCustomer({ ...newCustomer, email: e.target.value })} />
                                            <input required placeholder="Phone" className="p-3 text-sm bg-gray-50 border border-gray-200 rounded-lg text-gray-900 placeholder-gray-400 focus:border-solar focus:ring-1 focus:ring-solar outline-none transition-all" value={newCustomer.phone} onChange={e => setNewCustomer({ ...newCustomer, phone: e.target.value })} />
                                            <input required placeholder="Capacity (kW)" type="number" step="0.1" className="p-3 text-sm bg-gray-50 border border-gray-200 rounded-lg text-gray-900 placeholder-gray-400 focus:border-solar focus:ring-1 focus:ring-solar outline-none transition-all" value={newCustomer.capacity} onChange={e => setNewCustomer({ ...newCustomer, capacity: e.target.value })} />
                                        </div>
                                        <input required placeholder="Address" className="w-full p-3 text-sm bg-gray-50 border border-gray-200 rounded-lg text-gray-900 placeholder-gray-400 focus:border-solar focus:ring-1 focus:ring-solar outline-none transition-all" value={newCustomer.address} onChange={e => setNewCustomer({ ...newCustomer, address: e.target.value })} />
